...
1. Read the combined data attribute table and supporting data tables from LANDFIRE into R
...
Click the "Show" button to see code.  Data tables can be viewed below. 
<br>
