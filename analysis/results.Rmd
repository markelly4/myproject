...
![Figure 7. Map of historic percentages of late successional forest. Data mapped in ArcGIS Pro from LANDFIRE Biophysical Settings (BpS) data and BpS models.](assets/historicOldGrowth.jpg){width=50%}
...
![Figure 8. Map of current percentages of late successional forest. Data mapped in ArcGIS Pro from LANDFIRE Biophysical Settings (BpS) data, BpS models, and LANDFIRE Succession Classes (SClass).](assets/currentOldGrowth.jpg){width=50%}
...
![Figure 9. Map of percent change in late successional forest.  Data mapped in ArcGIS Pro from LANDFIRE Succession Classes (SClass) and Biophysical Settings (BpS).](assets/difference.jpg){width=50%}
...
![Figure 10. Chart showing change in amounts of late-successional habitat by ecosystem, from modeled historical to mapped 2020.](assets/stacked_reference_reduced.png){width=50%}
...
![Figure 11. Map of percent of historic late successional ecosystems that are classified as open canopy.](assets/historicOldGrowth_open.png){width=50%}
...
![Figure 12. Map of percent of historic late successional ecosystems that are classified as closed canopy.](assets/historicOldGrowth_closed.png){width=50%}
...
![Figure 13. Map of percent of current late successional ecosystems that are classified as open canopy.](assets/currentOldGrowth_open.png){width=50%}
...
![Figure 14. Map of percent of current late successional ecosystems that are classified as closed canopy.](assets/currentOldGrowth_closed.png){width=50%}
