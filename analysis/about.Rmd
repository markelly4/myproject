...
![Figure 5. Current Percentages of Late-Successional Forest](assets/currentOldGrowth.PNG)
...
![Figure 6. Chart representing historical ecosystems of the area of interest, split out by estimated acres of the various succession  classes pre-European Settlement.](stacked_reference_reduced.png)
...
![Figure 7. Map of historic percentages of late successional forest. Data mapped in ArcGIS Pro from LANDFIRE Biophysical Settings (BpS) data and BpS models.](historicOldGrowth.jpg)
...
![Figure 8. Map of current percentages of late successional forest. Data mapped in ArcGIS Pro from LANDFIRE Biophysical Settings (BpS) data, BpS models, and LANDFIRE Succession Classes (SClass).](currentOldGrowth.jpg)
...
![Figure 9. Map of percent change in late successional forest.  Data mapped in ArcGIS Pro from LANDFIRE Succession Classes (SClass) and Biophysical Settings (BpS).](difference.jpg)
...
![Figure 10. Chart showing change in amounts of late-successional habitat by ecosystem, from modeled historical to mapped 2020.](stacked_reference_reduced.png)
...
![Figure 11. Map of percent of historic late successional ecosystems that are classified as open canopy.](historicOldGrowth_open.png)
...
![Figure 12. Map of percent of historic late successional ecosystems that are classified as closed canopy.](historicOldGrowth_closed.png)
...
![Figure 13. Map of percent of current late successional ecosystems that are classified as open canopy.](currentOldGrowth_open.png)
...
![Figure 14. Map of percent of current late successional ecosystems that are classified as closed canopy.](currentOldGrowth_closed.png)
...
![Figure 15. Chart showing change in amounts of late-successional open and closed canopy habitat by ecosystem, from modeled historical to mapped 2020](og_change_by_canopy.png)
